...
import { PartnerSenzaAreaDetailsFields } from "./PartnerSenzaAreaDetailsFields";
import { ContattoFormFields } from "./ContattoFormFields";
import { ContattiList } from "./ContattiList";

interface PartnerSenzaAreaFormProps {
...
export const PartnerSenzaAreaForm: React.FC<PartnerSenzaAreaFormProps> = ({
  form,
  contatti,
  currentContatto,
  isLoading,
  ...
  return (
    <Form {...form}>
      <form onSubmit={onSubmit} className="space-y-4 py-4">
        <PartnerSenzaAreaDetailsFields form={form} />
